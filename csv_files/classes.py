                    ...
                    for spoor in traject.__dict__.items():
                        if spoor[1] is not '':
                            if (spoor[1] in kritiekeSporenLijst
                                and spoor[1] not in kritiekeSporen):
...
class Traject:
    def __init__(self, spoor1, spoor2 = '',
        spoor3 = '', spoor4 = '',spoor5 = '',
        spoor6 = '', spoor7= '', spoor8= '',
        spoor9 = ''):
        self.spoor1 = spoor1
        self.spoor2 = spoor2
        self.spoor3 = spoor3
...
with open('StationsHolland.csv') as csvfile:
    ...
    for station in stationsinfo:
        stationLijst.append(Station(station[0], station[1],
            station[2], station[3]))
